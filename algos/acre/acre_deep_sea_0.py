...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='deep_sea/5')
    ...
    # env = bsuite.load_from_id(args.env)
    # gym_env = gym_wrapper.GymFromDMEnv(env)

    acre(lambda: gym_wrapper.GymFromDMEnv(bsuite.load_from_id(args.env)), actor_critic=core.MLPActorCritic,
