...
def acre(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), reward_type=None, seed=0,
    ...
    if q_powered_gmm:
        ...
        gmm = GMM([env.observation_space, env.action_space], n_components, plot_gmm, env.goal_position)
        ...
        gmm = GMM([env.observation_space], n_components, plot_gmm, env.goal_position)
        # Count variables (protip: try to get a feel for how different size networks behave!)
