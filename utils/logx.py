...
class TensorBoardLogger():
    def __init__(self, logger_tb):
        self._set_up_tensorboard(logger_tb['instance_details'], logger_tb['aggregate_stats'])

    def _set_up_tensorboard(self, instance_details, aggregate_stats_every):
        # Tensorboard related
        self.aggregate_stats_every = aggregate_stats_every
        value = datetime.datetime.fromtimestamp(time.time())
        self.tensorboard_path = f"../../tensorboard/{instance_details}-{value.strftime('%Y-%m-%d_%H-%M-%S')}"
        try:
    ...
    def update_tensorboard(self, episode_reward, timesteps, learnt_ep_return=None):
